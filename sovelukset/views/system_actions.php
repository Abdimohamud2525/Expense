            ...
            <div class="col-md-12">
                <div class="card strpied-tabled-with-hover">
                    ...
                    <div class="card-body table-full-width table-responsive">
                        ...
                        <div class="modal" tabindex="-1" role="dialog" id="actionsModel">
                                        ...
                                        <form id="actionsForm">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label>system_actions</label>
                                                        <input type="text" name="system_actions" id="system_action" class="form-control" placeholder="system_actions">
                                                    </div>

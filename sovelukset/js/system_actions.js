  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (status) {
        ...
        $("#actionsTable tbody").append(tr) // Lisätään koko `<tr>` sisältö `<tbody>`-elementtiin
      }
    },
...
function delete_actions_Info(id) {
  let sendingData = {
    action: "delete_actions_info",
    id: id,
  }
  $.ajax({
    method: "POST",
...
// update
$("#actionsTable").on("click", ".update_info", function () {
  console.log("clicked")
...
// delete
$("#actionsTable").on("click", ".delete_info", function () {
